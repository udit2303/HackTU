...
class Area(Base):
    ...
    # EWS-specific fields
    monitored_hazards = Column(
        String, nullable=True
    )  # JSON string of hazard types being monitored
    ...
    soil_measurements = relationship(
        "SoilMeasurement", back_populates="area", cascade="all, delete-orphan"
    )
